...
const About = () => {
  const aboutData = [
    { icon: <BsTextRight />, title: "MCA", year: "Final year" },
    { icon: <BsTextRight />, title: "MERN", year: "0 - 1 year" },
    { icon: <BsTextRight />, title: "DSA", year: "0 - 1 year" },
  ];
      ...
      <div className="w-full h-full flex flex-col lg:flex-row  items-center justify-around gap-10 ">
        ...
        <motion.div variants={fadeIn("scaleUp",0.3,1.2)} initial="hidden" whileInView="show" className="flex-1 flex flex-col items-center lg:items-start max-w-[650px]">
          ...
          {/* text */}
            ...
            <p className="text-xl">
            Hi, I’m Prodip, a passionate full-stack developer and a final-year MCA student. I specialize in the MERN stack (MongoDB, Express.js, React.js, Node.js) and love building scalable, responsive, and interactive web applications. I’ve worked on a range of projects including AI chatbots, music apps, and algorithm-based research like the Largest Area Triangle problem. One of my standout full-stack projects is ChillBase—an Airbnb-inspired platform that allows users to post their properties for rent.

I’m driven by curiosity and a desire to solve real-world problems with clean, efficient code—blending creativity with technical depth in every project I build.
            </p>
