...
const Hero = () => {
  return (
    <section id="home" className="w-full h-screen pt-[100px] px-[6px] cut-bottom bg-waves1  bg-no-repeat bg-cover bg-center relative">
      <div className="absolute w-full h-screen top-0 left-0 xl:z-10 bg-waves2 bg-cover bg-no-repeat bg-center pointer-events-none"></div>
      <div className="flex flex-col lg:flex-row gap-10 justify-between items-center border border-transparent w-full h-full rounded-2xl  container mx-auto">
        ...
        >
          ...
          <div className="flex flex-col items-center text-center lg:text-start  lg:items-start">
            <h1 className="h1">MERN Stack Developer</h1>
            <p className="p">
            A focused and achievement-driven individual aims to promote a dynamic organization using a strong work ethic
 and a love of excellence. By focusing on collaboration and ongoing growth, I am dedicated to the success of
 organizational goals while at the same time further developing my own expertise within a challenging and
 dynamic environment.
            </p>
        ...
        {/* image */}
        <motion.div
          className=" hidden md:flex md:flex-col-reverse w-auto"
          variants={fadeIn("up", 0.3, 1.3)}
          initial="hidden"
          whileInView="show"
        >
          <img src="/portfolio.PNG" alt="avatar" className="object-cover  wave-bottom" />
        </motion.div>
      </div>
    </section>
  );
